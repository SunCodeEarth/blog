---
title: "Computational Environment on Mac OS"
author: "Shipeng Sun"
date: "2024-06-09"
slug: []
categories: Python
...
```{bash bash_conda, echo=TRUE, eval=FALSE}
...
`~` means your home directory, which can be replaced by `/Users/[your user name]`. Make sure the folder exists on the drive.
